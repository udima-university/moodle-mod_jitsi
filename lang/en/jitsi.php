...
$string['tokeninvitacion'] = 'Enter the token of the session you want to join here';
$string['tokeninvitacion_help'] = 'Enter this token in the Main session token field to share this session.';
