...
$string['recordex'] = 'Enable native Jitsi recording options (actually dropbox) to users with mod/jitsi:record capability enabled (teachers). If you config the above "Advance Streaming configuration" probably you will want to disable this.';
...
$string['accountex'] = 'Select the account for streaming';
$string['accounts'] = 'Accounts';
$string['accountconnected'] = 'Account connected';
$string['deletesources'] = 'Record sources';
$string['inuse'] = ' (in use)';
$string['deleteq'] = 'Delete and disconect?';
$string['loginq'] = 'Log in?';
$string['tablelistjitsis'] = "List with all the videos in your streaming provider which are available to be deleted because they are no more linked in Jitsi activities in this moodle instance. You can safely delete them in order to free up space on the streaming server. The list could include videos that now are in the 'Recycle bin' in some course. It's recommended to delete just old recordings that you know won't be required. </br></br> <b>¡¡¡ WARNING!!! </b>If you have moodle backup instances you should NOT remove these videos if they are linked in other instances.";
...
$string['raisehandex'] = 'Show the raisehad button to all users. When users raise their hands they can access to the participants panel. If you hide the participants panels to your users may be you should hide this button.';
...
$string['activatetooltip'] = 'Activate';
