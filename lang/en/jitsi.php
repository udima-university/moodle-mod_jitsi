...
$string['streamingconfigex'] = 'Youtube Streaming. For integrate method you need add the following url to Authorized redirect URIs \'{$a}\' on Google api console and must undergo an <a href=\'https://support.google.com/youtube/contact/yt_api_form?hl=enaudit\'>audit</a> to verify compliance with the Terms of Service of Youtube ';
