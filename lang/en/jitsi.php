...
$string['staticinvitationlinkex'] = 'Use this link for guests who don\'t have a Moodle user to access.';
...
$string['sharedsessionwithtoken'] = 'Session shared with token. Check this for enter the token of the other course';
