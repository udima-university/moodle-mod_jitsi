...
$string['jitsifieldset'] = 'Custom example fieldset';
$string['jitsiname'] = 'Session name';
$string['jitsiname_help'] = 'This is the content of the help tooltip associated with the jitsiname field. Markdown syntax is supported.';
$string['jitsi'] = 'Jitsi';
