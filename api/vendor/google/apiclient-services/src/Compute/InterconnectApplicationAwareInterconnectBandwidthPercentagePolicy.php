...
class InterconnectApplicationAwareInterconnectBandwidthPercentagePolicy extends \Google\Collection
{
  ...
  {
    return $this->bandwidthPercentages;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(InterconnectApplicationAwareInterconnectBandwidthPercentagePolicy::class, 'Google_Service_Compute_InterconnectApplicationAwareInterconnectBandwidthPercentagePolicy');
