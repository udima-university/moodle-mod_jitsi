 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class jitsi_press_button_desktop extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('pressdesktopbutton', 'jitsi');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' press desktop button in jitsi activity
