...
class jitsi_session_guest_form extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('guestform', 'jitsi');
    }
    ...
    public function get_description() {
        if ($this->userid != 0) {
            return "The user with id '$this->userid' enter to guest access form of jitsi with
                coursemodule id '$this->contextinstanceid'.";
        } else {
            return "Guest user enter to guest access form of jitsi with coursemodule id  '$this->contextinstanceid'.";
        }
    }
